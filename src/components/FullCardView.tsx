...
//       <div className="relative w-[95vw] max-w-6xl max-h-[95vh] bg-white rounded-2xl shadow-xl overflow-hidden flex">
//         {/* Close Button */}
//         <button
//           className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 z-50"
//           onClick={onClose}
...
//         {/* Left: Image */}
//         <div className="w-1/2 h-auto max-h-[95vh] bg-black flex items-center justify-center overflow-hidden">
//           {post.media[0]?.media_type === "image" && (
//             <img
//               src={post.media[0].media_url}
//               alt="Post"
...
//         {/* Right: Info and Actions */}
//         <div className="w-1/2 h-auto max-h-[95vh] overflow-y-auto p-6 space-y-4 flex flex-col">
//           {/* User Info */}
//           <div className="flex items-center space-x-4">
//             <img
//               src={post.profile_pic || "/default-avatar.png"}
