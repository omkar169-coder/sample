...
const PostCard: React.FC<PostCardProps> = ({ post, showMenu, setShowMenu }) => {
    ...
    <div className="bg-gray-100 p-3 sm:p-4 mb-4 rounded-lg shadow-sm relative">
      <div className="flex items-center gap-3 mb-2 sm:mb-3">
        ...
        {showMenu === post.question_id && (
          <div className="absolute right-0 top-0 mt-8 bg-white text-black shadow-lg rounded-lg p-2 w-36">
            <button
      ...
      {post.media.length > 0 && post.media[0].media_url && (
        <div className="mt-2">
          <img src={post.media[0].media_url} alt="Post media" className="w-full max-h-60 object-cover" />
        </div>
      )}
